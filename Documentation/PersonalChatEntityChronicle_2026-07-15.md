...
| Ingen data kan gå tapt på tvers av scaffolds | ikke implementert ennå | Krever durable replika-ack/quorum, replay ranges, placement og restore/fault-injection-bevis. |
