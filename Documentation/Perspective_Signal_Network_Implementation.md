# Perspective Signal Network (Binding Note)
...
## Product backlog context (non-canonical)

Potential future extensions that may be implemented above core protocol level:

- multi-hop signal runtime (TTL/hops queue)
- signal-path scoring as an additional route type
